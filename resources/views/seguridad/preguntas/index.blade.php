...
<span>Crear nueva preguntas de seguridad </span><i class="fas fa-plus-square"></i>
</a>
<div class="table-responsive-sm mt-5">
  ...
  <tbody>
    <tr>
      <td>1</td>
      <td>Nombre de tu videojuego favorito?</td>
      <td class="text-center">
        <form action="{{route('Pregunta.destroy',1)}}" method="POST">
              <a href="{{route('Pregunta.edit',1)}}"
